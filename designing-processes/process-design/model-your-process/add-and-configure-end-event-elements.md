...
5. Do one of the following:
   * From the **Elements** drop-down menu, select the **End Event** option. ![](../../../.gitbook/assets/end-event-selection-process-modeler-designer.png) 
...
After an End Event element is [added to a Process model](add-and-configure-end-event-elements.md#add-an-end-event-element), you may replace it with a different ending [Request](../../../using-processmaker/requests/what-is-a-request.md) event element:
...
1. ​[View your Processes](https://processmaker.gitbook.io/processmaker-4-community/-LPblkrcFWowWJ6HZdhC/~/drafts/-LRhVZm0ddxDcGGdN5ZN/primary/designing-processes/viewing-processes/view-the-list-of-processes/view-your-processes#view-all-processes). The **Processes** page displays.
2. Click the **Open Modeler** icon![](../../../.gitbook/assets/open-modeler-edit-icon-processes-page-processes.png)to edit the selected Process model. Process Modeler displays.
3. Select the End Event element to change to another ending Request event element. Available options display above the selected element.
4. Click the **Elements** icon. The **Elements** drop-down menu displays the ending Request event elements. ![](../../../.gitbook/assets/change-element-end-event-process-modeler-designer.png) 
5. Select the element to replace the End Event element. The **Change Type** screen displays to confirm replacing the currently selected element. ![](../../../.gitbook/assets/change-type-screen-process-modeler-designer.png) 
6. Click **Confirm**. The new element replaces the End Event element with its default settings and color.
...
The copied End Event element displays below the original. Any [Sequence Flow](process-modeling-element-descriptions.md#sequence-flow) and/or [Message Flow](process-modeling-element-descriptions.md#message-flow) elements incoming to or outgoing from the original are not copied.
