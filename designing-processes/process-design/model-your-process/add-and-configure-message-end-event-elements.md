...
3. Select the Message Event element or connector to delete. Available options display above the selected element. ![](../../../.gitbook/assets/delete-message-end-event-element-process-modeler-designer.png) 
