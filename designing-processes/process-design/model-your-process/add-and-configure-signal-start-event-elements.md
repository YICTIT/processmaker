...
Changing to a different starting Request event element replaces the selected Signal Start Event element with the default settings and color of the replacing element.
