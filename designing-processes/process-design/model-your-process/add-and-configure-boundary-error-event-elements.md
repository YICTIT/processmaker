...
## Change the Color of a Boundary Error Event Element

The Boundary Error Event element and label are black-colored by default. After a Boundary Error Event element is [added to a Process model](add-and-configure-boundary-error-event-elements.md#add-a-boundary-error-event-element), its shape and label color can be changed. Element and [connector](../model-processes-using-connectors/what-is-a-connector.md) colors may only be changed individually.
...
3. Select the Boundary Error Event element to change its color. Available options display above the selected element. ![](../../../.gitbook/assets/change-color-boundary-error-event-element-process-modeler-designer.png) 
...
5. Do one of the following:
   ...
   * **Specify a custom color:** Click the![](../../../.gitbook/assets/color-selector-swatch-process-modeler-designer.png)icon to display the color selector, and then select a color, enter the [Hex color code](https://www.color-hex.com/), or enter the red, green, blue, and alpha color values for the custom color. The Boundary Error element and label change to that color. ![](../../../.gitbook/assets/color-selector-process-modeler-designer.png) 
   * **Reset to the default color:** Click the![](../../../.gitbook/assets/reset-color-icon-process-modeler-designer.png)icon to reset the Boundary Error Event element and label to its default color.
