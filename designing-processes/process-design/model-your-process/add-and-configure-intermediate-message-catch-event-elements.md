...
5. From the **Elements** drop-down menu, select the **Intermediate Message Catch Event** option. The Intermediate Message Catch Event element displays. ![](../../../.gitbook/assets/intermediate-message-catch-event-selection-process-modeler-designer.png) 
...
## Change the Color of an Intermediate Message Catch Event Element

The Intermediate Message Catch Event element and label have a default yellow color to indicate that this element is an intermediate [Request](../../../using-processmaker/requests/what-is-a-request.md) event. After an Intermediate Message Catch Event element is [added to a Process model](add-and-configure-intermediate-signal-throw-event-elements.md#add-an-intermediate-signal-throw-event-element), its shape and label color can be changed. Element and [connector](../model-processes-using-connectors/what-is-a-connector.md) colors may only be changed individually.
...
3. Select the Intermediate Message Catch Event element to change its color. Available options display above the selected element. ![](../../../.gitbook/assets/change-color-intermediate-message-catch-event-element-process-modeler-designer.png) 
...
5. Do one of the following:
   ...
   * **Specify a custom color:** Click the![](../../../.gitbook/assets/color-selector-swatch-process-modeler-designer.png)icon to display the color selector, and then select a color, enter the [Hex color code](https://www.color-hex.com/), or enter the red, green, blue, and alpha color values for the custom color. The Intermediate Message Catch Event element and label change to that color. ![](../../../.gitbook/assets/color-selector-process-modeler-designer.png) 
   * **Reset to the default color:** Click the![](../../../.gitbook/assets/reset-color-icon-process-modeler-designer.png)icon to reset the Intermediate Message Catch Event element and label to its default color.

## Replace an Intermediate Message Catch Event Element with a Different Intermediate Request Event Element

After an Intermediate Message Catch Event element is [added to a Process model](add-and-configure-intermediate-message-catch-event-elements.md#add-an-intermediate-message-catch-event-element), you may replace it with a different intermediate [Request](../../../using-processmaker/requests/what-is-a-request.md) event element:
...
4. Click the **Elements** icon. The **Elements** drop-down menu displays the intermediate Request event elements. ![](../../../.gitbook/assets/change-element-intermediate-message-catch-event-process-modeler-designer.png) 
5. Select the element to replace the Intermediate Message Catch Event element. The **Change Type** screen displays to confirm replacing the currently selected element. ![](../../../.gitbook/assets/change-type-screen-process-modeler-designer.png) 
...
Copying an Intermediate Message Catch Event element copies the original along with its current settings, making it easier and faster to continue designing without adding default elements or [connectors](../model-processes-using-connectors/what-is-a-connector.md) with their default settings.

The copied Intermediate Message Catch Event element displays below the original. Any [Sequence Flow](process-modeling-element-descriptions.md#sequence-flow) and/or [Message Flow](process-modeling-element-descriptions.md#message-flow) elements incoming to or outgoing from the original are not copied.
...
1. ​[View your Processes](https://processmaker.gitbook.io/processmaker-4-community/-LPblkrcFWowWJ6HZdhC/~/drafts/-LRhVZm0ddxDcGGdN5ZN/primary/designing-processes/viewing-processes/view-the-list-of-processes/view-your-processes#view-all-processes). The **Processes** page displays.
2. Click the **Open Modeler** icon![](../../../.gitbook/assets/open-modeler-edit-icon-processes-page-processes.png)to edit the selected Process model. Process Modeler displays.
3. Select the Intermediate Message Catch Event element to copy. Available options display above the selected element. ![](../../../.gitbook/assets/copy-intermediate-message-catch-event-element-process-modeler-designer.png) 
4. Click the **Copy Element** icon![](../../../.gitbook/assets/copy-element-icon-process-modeler-designer.png). The Process model element copies. ![](../../../.gitbook/assets/copied-intermediate-message-catch-event-element-process-modeler-designer.png) 
...
* **Configuration** panel
  ...
  * [Select the element from which to listen for a message](add-and-configure-intermediate-message-catch-event-elements.md#select-the-element-from-which-to-listen-for-a-message)
...
![Intermediate Message Catch Event element with an assigned ProcessMaker Vocabulary](../../../.gitbook/assets/intermediate-message-catch-event-vocabulary-process-modeler-designer.png)
