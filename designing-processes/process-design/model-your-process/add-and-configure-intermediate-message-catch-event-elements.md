...
4. Click the **Copy Element** icon![](../../../.gitbook/assets/remove-icon.png). The Process model element copies. ![](../../../.gitbook/assets/copied-intermediate-message-catch-event-element-process-modeler-designer.png) 
