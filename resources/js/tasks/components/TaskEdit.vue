        ...
        <div class="d-flex flex-column flex-md-row">
            <div class="flex-grow-1">
                <div v-if="isSelfService" class="alert alert-primary" role="alert">
                    <button type="button" class="btn btn-primary" @click="claimTask">{{$t('Claim Task')}}</button>
                                ...
                                <div class="card card-body border-top-0 h-100">
                                    <template v-if="task.component">
                                        <component
                                            ...
                                            :csrf-token="window.ProcessMaker.crfToken"
                    ...
                    <ul class="list-group list-group-flush w-100">
                        ...
                        <li class="list-group-item">
                            ...
                            <span>
                                ...
                                <b-modal v-model="showReassignment" size="md" centered :title="$t('Reassign to')"
                                        @hide="cancelReassign"
                        ...
                        <li class="list-group-item">
                            <h5>{{$t('Request')}}</h5>
                            <a href="#" @click="loadRequestRoute">#{{ task.process_request_id }} 
                                <!-- {{task.process.name}} -->
                            </a>
    ...
    export default {
        data() {
            return {
                ...
                task: window.ProcessMaker.editTask,
        ...
        methods: {
            ...
            loadRequestRoute() {
                window.location = "/requests/" + this.task.process_request_id;
                // processmaker.apiClient
                // .get('requests/' + this.task.process_request_id);
            }
        },
        mounted () {
