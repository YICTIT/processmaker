                        ...
                        <div class="card card-body border-top-0 p-0" v-bind:class="{ 'tab-pane':true, active: showSummary }" id="summary"
                            ...
                            <template v-if="showSummary">
                                <template v-if="showScreenSummary">
                                    <div class="p-3">
                                        <task-form ref="screen" :screen="screenSummary.config" :data="dataSummary" :computed="screenSummary.computed" />
                                    </div>
                                </template>
                                <template v-else>
                            ...
                            <template v-else>
                                <template v-if="showScreenRequestDetail">
                                    <div class="card">
                                        <div class="card-body">
                                            <task-form ref="screenRequestDetail" :screen="screenRequestDetail" :data="dataSummary"/>
                                        </div>
                                    </div>
                                </template>
                                <template v-else>
